<template>
  <div class="tw-mt-1 tw-max-w-full sm:tw-mt-2 sm:tw-max-w-[calc(100%-236px)]">
    <div
      ...
      class="tw-flex tw-w-full tw-cursor-pointer tw-items-center tw-gap-2 tw-rounded-md tw-border tw-border-border-secondary tw-bg-surface-secondary tw-p-2 tw-text-xs tw-font-normal tw-text-fg-tertiary hover:tw-bg-surface-tertiary sm:tw-text-sm"
    >
